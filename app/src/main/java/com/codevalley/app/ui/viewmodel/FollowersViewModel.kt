...
class FollowersViewModel @Inject constructor(
    ...
    private val _followers = MutableStateFlow<List<UserFriendDTO>>(emptyList())
    val followers: StateFlow<List<UserFriendDTO>> = _followers

    private val _pendingRequests = MutableStateFlow<List<UserFriendDTO>>(emptyList())
    val pendingRequests: StateFlow<List<UserFriendDTO>> = _pendingRequests
